...
def start_ec2_via_lambda() -> str:
    try:
        response = lambda_client.invoke(FunctionName="automate_auto_start_for_ec2_proxy_for_redis",InvocationType="RequestResponse",Payload=json.dumps({})) # if your Lambda expects input, add it here)
